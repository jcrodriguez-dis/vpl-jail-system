...
#define JAIL_HARVEST_TIMEOUT 30
#define JAIL_OUTPUT_BUFFER_SIZE (10 * 1024 * 1024)
#define JAIL_NET_BUFFER_SIZE (256 * 1024)
#define JAIL_ACCEPT_WAIT 500
#define JAIL_WEBSOCKET_FRAME_SIZE_LIMIT (20 * 1024 * 1024)
#define JAIL_VPL_EXTRA_TIME 2
